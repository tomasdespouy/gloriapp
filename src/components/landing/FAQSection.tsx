...
export default function FAQSection() {
  ...
  const FAQS = [
    ...
    { q: "\u00bfC\u00f3mo se eval\u00faan mis competencias?", a: "Al finalizar cada sesi\u00f3n, la IA eval\u00faa 10 competencias cl\u00ednicas basadas en la Pauta para la Evaluaci\u00f3n de Competencias Psicoterape\u00fauticas para el trabajo con Adultos (Vald\u00e9s & G\u00f3mez, 2023), publicada en 'Supervisi\u00f3n cl\u00ednica para estudiantes de Psicolog\u00eda' (Ediciones Universidad Santo Tom\u00e1s). Las competencias incluyen escucha activa, contenci\u00f3n de afectos, setting terap\u00e9utico, actitud no valorativa, entre otras." },
