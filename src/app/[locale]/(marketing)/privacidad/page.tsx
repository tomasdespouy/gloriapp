    ...
    <>
      ...
      <main className="bg-[#FAFAFA] min-h-screen">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">{dict["footer.privacy"] || "footer.privacy"}</h1>
          ...
          <div className="prose prose-sm prose-gray max-w-none text-gray-600">
            <p>
              {locale === "en"
                ? "Please refer to the Spanish version for the full privacy policy."
                : "Consulte a versão em espanhol para a política de privacidade completa."}
            </p>
            <p className="mt-4">
              <Link href="/privacidad" className="text-sidebar hover:underline">
                {locale === "en" ? "View Privacy Policy (Spanish)" : "Ver Política de Privacidade (Espanhol)"}
              </Link>
            </p>
          </div>
