...
export const LEARNING_DATA: CompetencyLearning[] = [
...

  {
    ...
    examples: [
      ...
      {
        id: "esc-6",
        title: "Qué abre y qué cierra el vínculo",
        context: "Paciente de 29 años que cuenta, dudando, que discutió con su madre y dejó de hablarle.",
        dialogue: [
          { role: "patient", content: "Discutí con mi mamá y llevo dos semanas sin hablarle. No sé si hice bien." },
          { role: "therapist", content: "Usted debería llamarla y arreglar las cosas; la familia es lo más importante." },
          { role: "patient", content: "[Se encoge de hombros] Ya... supongo. No sé, da igual." },
          { role: "therapist", content: "Perdón, me adelanté. Debe ser muy difícil estar así con tu mamá después de algo tan fuerte. ¿Qué fue lo que más te dolió de esa discusión?" },
          { role: "patient", content: "Que me dijo que siempre la decepciono. Eso me quebró." },
        ],
        explanation: "El consejo prematuro ('debería llamarla') sube la resistencia y baja la alianza: el paciente se cierra. La reparación —validar el dolor y abrir con una pregunta— recupera el vínculo y el paciente profundiza. Validar, reformular y preguntar abierto ABREN; aconsejar, confrontar o interpretar antes de tiempo CIERRAN.",
        tip: "ABREN: validar ('debe ser difícil...'), reformular ('lo que escucho es...'), preguntar abierto ('¿cómo te sentiste?'), normalizar ('le pasa a mucha gente'), resumir. CIERRAN: dar consejos ('debería...'), confrontar sin confianza ('pero antes dijiste...'), interpretar de más ('en el fondo usted...'), encadenar preguntas de sí/no.",
      },
    ],
  },

  {
    ...
    examples: [
      ...
      {
        id: "nov-6",
        title: "Confrontar: con vínculo abre, sin vínculo cierra",
        context: "Paciente de 34 años, en su segunda sesión, dice que 'no le afecta' la separación pero llega a cada sesión hablando de su ex.",
        dialogue: [
          { role: "patient", content: "Le digo que ya lo superé. No me afecta para nada." },
          { role: "therapist", content: "Pero cada sesión empiezas hablando de él. Eso es una contradicción, ¿no?" },
          { role: "patient", content: "[A la defensiva] No sé por qué dice eso. Vine a otra cosa." },
          { role: "therapist", content: "Tienes razón, me apuré. Lo que noto es que es un tema que sigue presente, y eso es entendible. ¿Te parece si lo miramos sin etiquetarlo?" },
        ],
        explanation: "Señalar la contradicción sin alianza suficiente dispara resistencia y defensa. La misma observación, ofrecida con cuidado cuando ya hay confianza, puede impulsar el insight. La confrontación y la interpretación son herramientas potentes, pero su efecto depende del vínculo previo.",
        tip: "Antes de confrontar o interpretar, pregúntate: ¿hay alianza suficiente? Si recién empiezas, valida y explora; guarda la confrontación para cuando el vínculo aguante.",
      },
    ],
  },
