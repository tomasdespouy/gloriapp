...
> **Reclasificación APLICADA a PROD el 2026-06-25** (8 movimientos). Jimena queda
> PENDIENTE de reescritura (ver §4). Los códigos DSM-5 / CIE-11 son aproximaciones
> docentes, no diagnósticos formales.
...
- Distribución tras reclasificación: **9 principiante / 15 intermedio / 10 avanzado**
  (→ 11 avanzado / 14 intermedio cuando Jimena suba a avanzado).
...
| Altagracia Marte | R. Dom. | T. depresivo mayor c/ideación pasiva + afrontamiento de enfermedad · F32 / 6A70 + QD7 | = | 🔴 |
...
| Hernán Mejía | Colombia | T. de adaptación + duelo anticipatorio + problema espiritual · F43.2 / 6B43 + QE65 | = | — |
| Jorge Ramírez | México | T. explosivo intermitente + duelo no resuelto · F63.81 / 6C73 | = | 🟠 |
| Macarena Sepúlveda | Chile | Burnout + duelo prolongado · QD85 + 6B42 (Z73.0) | = | 🟠 |
...
| Jimena Ramírez | México | (reescritura pendiente — ver §4) | **↑ I→A** pend. | 🔴→ |

### Intermedio (15 → 14 con Jimena)
...
| Ignacio Poblete | Chile | Depresión enmascarada + alexitimia + problema conyugal · F32 / 6A70 + QE52 | = | — |
...
| Paciente | País | Patología — DSM-5 / CIE-11 | Cambio | Alarma |
|---|---|---|:--:|:--:|
| Camila Bertoni | Argentina | T. de pánico · F41.0 / 6B01 | = | ⚠ falso positivo |
...
| Mariana Sánchez | México | T. de ansiedad generalizada + perfeccionismo · F41.1 / 6B00 | **↓ I→P** (borderline) | — |

## 4. Pacientes críticos (🔴) y reescritura de Jimena

Decisión: **se mantienen los críticos, todos en AVANZADO** (Alejandro, Altagracia,
Edwin, Carlos Paredes ya están; Jimena sube tras reescritura). Los prompts ya
acotan el riesgo a "pasivo, sin plan, sin intención".

**Jimena Ramírez — reescritura PENDIENTE de aplicar.** Hoy: autolesión explícita
(cortes, cicatrices, "[se baja las mangas]") + fantasías suicidas. Objetivo:
avanzado pero menos sensible/explícito. Dos variantes (detalle en el chat):
- **A (recomendada):** desregulación emocional (enojo/bloqueo) + fantasía de
  *escape relacional* (irse, desaparecer de la vista — NO hacerse daño). Sin
  autolesión ni ideación suicida. Lo "avanzado" lo da el testeo de la alianza.
- **B:** sin autolesión, con ideación pasiva muy acotada ("todo sería más fácil
  si no estuviera — sin plan, me asusta"), tras alianza alta.
...
1. Aprobar variante de reescritura de Jimena (A o B) → aplicar prompt + subir a avanzado.
2. Revisar si Mariana Sánchez (↓ I→P) calza en principiante (fue el movimiento borderline).
